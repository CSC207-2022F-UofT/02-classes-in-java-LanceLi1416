...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param name_first the first half of the name of this Silly instance.
     * @param name_second the second half of the name of this Silly instance.
     */
    public Silly(String name_first, String name_second) {
        this.name = name_first + name_second;
    }
